...
public:
  ...
  using import_field_type  = Field<      Real,device_type>;
  using export_field_type  = Field<const Real,device_type>;
...
protected:
  ...
  using imports_hview_type = ko::Unmanaged<KokkosTypes<host_device_type>::view_2d<double>>;

  using exports_dview_type = KokkosTypes<device_type>::view_2d<double>;
  using exports_hview_type = ko::Unmanaged<KokkosTypes<host_device_type>::view_2d<double>>;
